...
namespace WindowsFormsApp5
{
    public partial class WeatherData : Form
    {
        ...
        public WeatherData(WeatherSettings _weathersettings)
        {
            ...
            {
                TotalCities = _settings._cities.Count;
        ...
        private void DisplaySettingForm()
        {
            ...
            if (_settingForm.Weathersettings != null)
            {
                _settings = _settingForm.Weathersettings;

                if (_settings._cities != null && _settingForm.Weathersettings != null)
                {
                    TotalCities = _settings._cities.Count;
                    timer1.Interval = (int)(_settings._refreshTime) * 1000;
                }
